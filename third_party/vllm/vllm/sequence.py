...
class MultiHeadRequestState:
    ...
    # Per-step deltas emitted by output processors. These allow consumers to
    # avoid repeatedly copying full side-token histories every scheduler step.
    last_stoken_token_ids: Optional[List[int]] = None
    last_control_token_ids: Optional[List[int]] = None
